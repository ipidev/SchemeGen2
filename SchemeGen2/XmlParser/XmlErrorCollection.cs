...
namespace SchemeGen2.XmlParser
{
	...
	class XmlErrorCollection
	{
		...
		{
			string errorString = String.Format("The values generated by '{0}' must be within the range [{1} - {2}].",
				element.Name.LocalName, settingLimits.Minimum, settingLimits.Maximum);
